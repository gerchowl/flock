...
| Client resilience | Per-slot writer actor: no blocking I/O on the render loop, off-loop bridge teardown, redial circuit breaker, active-slot degrade-to-home | In review | ADR-0005 | #176 |

...
pub struct App {
    ...
    /// An issue-guard fetch is running off-loop (#302).
    pub(crate) issue_guard_fetch_in_flight: bool,
...
impl App {
    pub fn new(
        ...
        crate::system_stats::spawn_sampler(
            event_tx.clone(),
        ...
        let mut this = Self {
            ...
            issue_guard_fetch_in_flight: false,
    ...
    fn apply_live_config(
        ...
        if !invalid_section("ui") {
            ...
            .is_none()
            {
                ...
                self.state.server_label = config.ui.server_label;
            ...
            app.handle_api_request_after_internal_events_drained(crate::api::schema::Request {
                ...
                method: crate::api::schema::Method::NotificationShow(
                    crate::api::schema::NotificationShowParams {
                        ...
                        position: Some(crate::config::ToastFlockPosition::TopLeft),

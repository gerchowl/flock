...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=FLOCK_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=FLOCK_BUILD_ID");
    println!("cargo:rerun-if-env-changed=FLOCK_BUILD_COMMIT");
